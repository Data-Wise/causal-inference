...
This is where Directed Acyclic Graphs (DAGs) and Judea Pearl's **backdoor criterion** provide a rigorous, graphical roadmap [@Pearl2016-jc, Chapter 3].
...
::: {.cell-output-display}
![Distribution of the confounder (age) by treatment group. The severe lack of overlap indicates a practical violation of the positivity assumption.](_week-03_exchangeability_positivity_files/figure-html/fig-positivity-violation-1.png){#fig-positivity-violation width=672}
:::
:::
...
::: {.cell-output-display}
![Assessing overlap for Age and Motivation. The distributions show good common support.](_week-03_exchangeability_positivity_files/figure-html/fig-lab-positivity-check-1.png){#fig-lab-positivity-check width=672}
:::
:::
