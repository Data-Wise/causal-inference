...
**Description**:
The simplest and most versatile method for subsetting in R. Use `[]` to extract rows, columns, or individual elements from data frames or matrices.
...
**Description**:
Provides a more human-readable syntax for subsetting.
...
- **Issue**: Subsetting returns no rows.
	Fix: Ensure logical conditions are met.

FAQs:

- How to subset with regex?
